...
export const dictionaries = {
  fr: {
    ...
    'clients.modal.create.field.siren.helper': '9 chiffres, sans espaces.',
    ...
    'pipeline.board.keyboardHint':
      'Fiche sélectionnée : flèches gauche et droite pour changer d’étape.',
    ...
    // ── Phase 34 — Fiche client (FICHE-01..05, ACTV-01..05) ────────────────────
    // The complete Phase 34 key set, added in one pass (plan 34-01 task 3) so no
    // later plan in the phase has to edit this file. Some keys below are consumed
    // only by plans 34-09/10/11; they are here on purpose.
    // Tabs + header (FICHE-05).
    'clients.detail.tab.informations': 'Informations',
    'clients.detail.tab.contacts': 'Contacts',
    'clients.detail.tab.proposals': 'Propositions',
    'clients.detail.tab.activity': 'Activité',
    'clients.detail.header.modify': 'Modifier',
    'clients.detail.header.nextAction': 'Prochaine action : {0}',
    'clients.detail.header.noNextAction': 'Aucune action prévue',
    // Registry panel (FICHE-02). Read-only: nothing but the SIRENE lookup writes
    // these fields (D-02), so there is no edit control and no submit key here.
    'clients.registry.title': 'Identité (registre)',
    'clients.registry.syncedAt': 'Synchronisé le {0}',
    'clients.registry.neverSynced': 'Jamais synchronisé',
    'clients.registry.refresh': 'Actualiser',
    'clients.registry.refreshing': 'Actualisation…',
    'clients.registry.toast.synced': 'Informations mises à jour depuis le registre.',
    'clients.registry.toast.notFound': 'Aucune entreprise trouvée pour ce SIREN.',
    'clients.registry.toast.error': 'Le registre est indisponible. Réessayez plus tard.',
    'clients.registry.status.synced': 'Synchronisé',
    'clients.registry.status.pending': 'Non synchronisé',
    'clients.registry.status.notFound': 'Introuvable',
    'clients.registry.status.error': 'Erreur',
    'clients.registry.state.active': 'En activité',
    'clients.registry.state.ceased': 'Cessée',
    'clients.registry.field.legalName': 'Raison sociale',
    'clients.registry.field.address': 'Adresse',
    'clients.registry.field.legalForm': 'Forme juridique',
    'clients.registry.field.activity': 'Activité',
    'clients.registry.field.headcount': 'Effectif',
    'clients.registry.field.foundedOn': 'Date de création',
    'clients.registry.field.state': 'État',
    'clients.registry.empty':
      'Cette société n’a pas encore été synchronisée avec le registre. Actualisez pour récupérer son identité.',
    // Relation panel (FICHE-04) — private tier, visible to the owning partner only.
    // The `.siteWeb` key deliberately differs from the `site_web` enum value;
    // LEAD_SOURCE_DICT_KEY in src/lib/relationship/kinds.ts maps the two explicitly.
    'clients.relation.title': 'Relation',
    'clients.relation.modify': 'Modifier',
    'clients.relation.field.leadSource': 'Source',
    'clients.relation.field.description': 'Description',
    'clients.relation.field.nextActionAt': 'Prochaine action',
    'clients.relation.field.nextActionNote': 'Note de suivi',
    'clients.relation.source.recommandation': 'Recommandation',
    'clients.relation.source.prospection': 'Prospection',
    'clients.relation.source.salon': 'Salon',
    'clients.relation.source.siteWeb': 'Site web',
    'clients.relation.source.autre': 'Autre',
    'clients.relation.source.placeholder': 'Choisir une source',
    'clients.relation.empty': 'Vous n’avez encore rien noté sur cette relation.',
    'clients.relation.dialog.title': 'Modifier la relation',
    'clients.relation.dialog.submit': 'Enregistrer',
    'clients.relation.toast.updated': 'Relation mise à jour.',
    // Company (shared-display tier) dialog (FICHE-03). The hint is what justifies
    // the audit row on every write here (D-03).
    'clients.company.dialog.title': 'Modifier la société',
    'clients.company.dialog.hint':
      'Ces informations sont partagées : les autres partenaires liés à cette société les voient aussi.',
    'clients.company.field.name': 'Nom affiché',
    'clients.company.field.website': 'Site web',
    'clients.company.field.phone': 'Téléphone',
    'clients.company.field.siren': 'SIREN',
    'clients.company.field.sirenHelper':
      '9 chiffres, sans espaces. Corriger le SIREN relance la recherche au registre.',
    'clients.company.dialog.submit': 'Enregistrer',
    'clients.company.toast.updated': 'Société mise à jour.',
    // Timeline (ACTV-01/02/03).
    'clients.timeline.title': 'Activité',
    'clients.timeline.empty': 'Aucune activité pour l’instant.',
    'clients.timeline.filter.all': 'Tout',
    'clients.timeline.filter.notes': 'Notes',
    'clients.timeline.filter.system': 'Système',
    'clients.timeline.actor.system': 'Système',
    'clients.timeline.bucket.today': 'Aujourd’hui',
    'clients.timeline.bucket.yesterday': 'Hier',
    'clients.timeline.bucket.earlier': 'Plus tôt',
    'clients.timeline.kind.note': 'Note',
    'clients.timeline.kind.stageChanged': 'Changement d’étape',
    'clients.timeline.kind.proposalFinalized': 'Proposition finalisée',
    'clients.timeline.kind.outcomeSet': 'Issue enregistrée',
    'clients.timeline.kind.registrySynced': 'Registre synchronisé',
    'clients.timeline.kind.nextActionSet': 'Prochaine action définie',
    'clients.timeline.note.label': 'Ajouter une note',
    'clients.timeline.note.placeholder': 'Ce que vous voulez retenir de cet échange…',
    'clients.timeline.note.submit': 'Ajouter',
    'clients.timeline.note.toast.added': 'Note ajoutée.',
    'clients.timeline.note.dateLabel': 'Date',
    // {0} = the origin stage, {1} = the destination stage. Both are substituted
    // at the call site with .replace(), never in this value (house rule).
    'clients.timeline.event.stageChanged': 'Étape passée de {0} à {1}',
    // Next action (ACTV-04).
    'clients.nextAction.dialog.title': 'Planifier la prochaine action',
    'clients.nextAction.dialog.dateLabel': 'Date',
    'clients.nextAction.dialog.noteLabel': 'Note (facultatif)',
    'clients.nextAction.dialog.submit': 'Enregistrer',
    'clients.nextAction.dialog.clear': 'Retirer',
    'clients.nextAction.dialog.toast.set': 'Prochaine action enregistrée.',
    'clients.nextAction.dialog.toast.cleared': 'Prochaine action retirée.',
    // Bounded error key for src/lib/relationship/actions.ts. Deliberately the same
    // copy as clients.toast.error: namespaces in this file do not share keys
    // (clients.toast.error and admin.reconciliation.toast.error already coexist
    // with identical copy). Never alias across namespaces.
    'relationship.toast.error': 'Une erreur est survenue. Réessayez.',
    // Shared validation message for the FICHE-03 website field. Minted here only
    // after grepping: error.field.required, .siren.invalid, .email.invalid and
    // .phone.invalid already exist and are reused by name; no URL key did.
    'error.field.url.invalid': 'Adresse web invalide.',
    // Home "à relancer" card (ACTV-05). D-20 puts this on the home page, not on
    // the client page and not on the pipeline board.
  ...
  en: {
    ...
    'clients.modal.create.field.siren': 'SIREN',
    'clients.modal.create.field.siren.helper': '9 digits, no spaces.',
    ...
    'pipeline.board.keyboardHint': 'Card focused: use the left and right arrow keys to change stage.',
    ...
    // ── Phase 34 — Fiche client (FICHE-01..05, ACTV-01..05) ────────────────────
    'clients.detail.tab.informations': 'Information',
    'clients.detail.tab.contacts': 'Contacts',
    'clients.detail.tab.proposals': 'Proposals',
    'clients.detail.tab.activity': 'Activity',
    'clients.detail.header.modify': 'Edit',
    'clients.detail.header.nextAction': 'Next action: {0}',
    'clients.detail.header.noNextAction': 'No action planned',
    'clients.registry.title': 'Identity (registry)',
    'clients.registry.syncedAt': 'Synced on {0}',
    'clients.registry.neverSynced': 'Never synced',
    'clients.registry.refresh': 'Refresh',
    'clients.registry.refreshing': 'Refreshing…',
    'clients.registry.toast.synced': 'Details updated from the registry.',
    'clients.registry.toast.notFound': 'No company found for this SIREN.',
    'clients.registry.toast.error': 'The registry is unavailable. Try again later.',
    'clients.registry.status.synced': 'Synced',
    'clients.registry.status.pending': 'Not synced',
    'clients.registry.status.notFound': 'Not found',
    'clients.registry.status.error': 'Error',
    'clients.registry.state.active': 'Active',
    'clients.registry.state.ceased': 'Ceased',
    'clients.registry.field.legalName': 'Legal name',
    'clients.registry.field.address': 'Address',
    'clients.registry.field.legalForm': 'Legal form',
    'clients.registry.field.activity': 'Activity',
    'clients.registry.field.headcount': 'Headcount',
    'clients.registry.field.foundedOn': 'Founded on',
    'clients.registry.field.state': 'Status',
    'clients.registry.empty':
      'This company has not been synced with the registry yet. Refresh to fetch its identity.',
    'clients.relation.title': 'Relationship',
    'clients.relation.modify': 'Edit',
    'clients.relation.field.leadSource': 'Source',
    'clients.relation.field.description': 'Description',
    'clients.relation.field.nextActionAt': 'Next action',
    'clients.relation.field.nextActionNote': 'Follow-up note',
    'clients.relation.source.recommandation': 'Referral',
    'clients.relation.source.prospection': 'Outbound',
    'clients.relation.source.salon': 'Trade show',
    'clients.relation.source.siteWeb': 'Website',
    'clients.relation.source.autre': 'Other',
    'clients.relation.source.placeholder': 'Pick a source',
    'clients.relation.empty': 'You have not recorded anything about this relationship yet.',
    'clients.relation.dialog.title': 'Edit relationship',
    'clients.relation.dialog.submit': 'Save',
    'clients.relation.toast.updated': 'Relationship updated.',
    'clients.company.dialog.title': 'Edit company',
    'clients.company.dialog.hint':
      'These details are shared: other partners linked to this company see them too.',
    'clients.company.field.name': 'Display name',
    'clients.company.field.website': 'Website',
    'clients.company.field.phone': 'Phone',
    'clients.company.field.siren': 'SIREN',
    'clients.company.field.sirenHelper':
      '9 digits, no spaces. Correcting the SIREN re-runs the registry lookup.',
    'clients.company.dialog.submit': 'Save',
    'clients.company.toast.updated': 'Company updated.',
    'clients.timeline.title': 'Activity',
    'clients.timeline.empty': 'No activity yet.',
    'clients.timeline.filter.all': 'All',
    'clients.timeline.filter.notes': 'Notes',
    'clients.timeline.filter.system': 'System',
    'clients.timeline.actor.system': 'System',
    'clients.timeline.bucket.today': 'Today',
    'clients.timeline.bucket.yesterday': 'Yesterday',
    'clients.timeline.bucket.earlier': 'Earlier',
    'clients.timeline.kind.note': 'Note',
    'clients.timeline.kind.stageChanged': 'Stage change',
    'clients.timeline.kind.proposalFinalized': 'Proposal finalised',
    'clients.timeline.kind.outcomeSet': 'Outcome recorded',
    'clients.timeline.kind.registrySynced': 'Registry synced',
    'clients.timeline.kind.nextActionSet': 'Next action set',
    'clients.timeline.note.label': 'Add a note',
    'clients.timeline.note.placeholder': 'What you want to remember from this exchange…',
    'clients.timeline.note.submit': 'Add',
    'clients.timeline.note.toast.added': 'Note added.',
    'clients.timeline.note.dateLabel': 'Date',
    'clients.timeline.event.stageChanged': 'Stage moved from {0} to {1}',
    'clients.nextAction.dialog.title': 'Schedule the next action',
    'clients.nextAction.dialog.dateLabel': 'Date',
    'clients.nextAction.dialog.noteLabel': 'Note (optional)',
    'clients.nextAction.dialog.submit': 'Save',
    'clients.nextAction.dialog.clear': 'Clear',
    'clients.nextAction.dialog.toast.set': 'Next action saved.',
    'clients.nextAction.dialog.toast.cleared': 'Next action cleared.',
    'relationship.toast.error': 'Something went wrong. Try again.',
    'error.field.url.invalid': 'Invalid web address.',
