...
// NOTE: ReUI ships this importing `Plus01Icon`, which does not exist in
// @hugeicons/core-free-icons — the correct export is `PlusSignIcon`.
// Re-apply this rename if the block is re-imported from the registry.
