...
/** Undo (Iconly #54827) */
export function UndoIcon({ size = 24, ...props }: UndoIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
