...
/** Chart (Iconly #486) */
export function BarChartIcon({ size = 24, ...props }: BarChartIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
