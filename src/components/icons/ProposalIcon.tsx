...
export interface ProposalIconProps extends React.SVGProps<SVGSVGElement> {
  /** Rendered width and height. Defaults to 24. */
  size?: number | string;
}

/** Document (Iconly #494) */
export function ProposalIcon({ size = 24, ...props }: ProposalIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
