...
/** Show (Iconly #533) */
export function EyeIcon({ size = 24, ...props }: EyeIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
