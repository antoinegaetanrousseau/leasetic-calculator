...
// NOTE: strokeWidth is omitted from the public props because HugeiconsIcon types it
// as `number`, while React.ComponentProps<"svg"> widens it to `string | number`.
// Re-apply this if the component is re-imported from the ReUI registry.
