...
// Navbar presence with sales team avatars and invite.
  ...
  return (
    <div className="flex shrink-0 items-center gap-2">
      ...
      <AvatarGroup>
        ...
        <AvatarGroupCount className="text-[10px] leading-none">
          +{TEAM_EXTRA_COUNT}
        </AvatarGroupCount>
      </AvatarGroup>
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger
          render={
            <Button variant="outline" aria-label="Invite sales teammate" />
          }
        >
        ...
        <PopoverContent sideOffset={7} align="end" className="w-72">
          <div className="flex flex-col gap-3">
            <h4 className="text-foreground text-sm">Invite teammate</h4>
