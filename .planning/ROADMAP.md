...
**Plans**: 6 plans
  - [ ] 13-01-PLAN.md — Wizard primitives (WizardActionBar, PlusDeDetailsAccordion, PdfPreviewMock, RecapSection) + ~45 wizard.* i18n keys
  - [ ] 13-02-PLAN.md — Server actions (saveAndAdvance, saveAsDraft, persistAccordionOpen) + POST /api/proposals/finalize + completedSteps helper + legacy /proposals/new redirect
...
| 13. 3-Step Proposal Wizard | v1.2 | 0/6 | Planned | — |
