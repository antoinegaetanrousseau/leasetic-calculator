...
**Plans**: 6 plans
  ...
  - [x] 13-05-PLAN.md — Step 3 route /proposals/new/verification (2-column review + PdfPreviewMock + FinalizeButton wired to D-16 pipeline)
  - [x] 13-06-PLAN.md — Stepper state semantics integration tests + ADMIN-09 no-commission-in-PDF golden corpus test + D-28 STRIDE addendum + manual smoke runbook
**UI hint**: yes
